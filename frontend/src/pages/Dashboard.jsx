...
function StepRow({ icon, label, sub, index }) {
  ...
  const colors = {
    waiting: { bg: '#1a1d2e', border: '#2d3148', text: '#9ca3af' },
    active : { bg: '#1a1f3a', border: '#667eea', text: '#ffffff' },
    done   : { bg: '#0a1f14', border: '#34d399', text: '#34d399' },
  };
      ...
      <div>
        {status === 'waiting' && (
          <div style={{
            ...
            borderRadius: '50%', background: '#2d3148'
          }} />
        )}
        {status === 'active' && (
...
export default function Dashboard() {
  ...
  // ── PDF Upload Handler (Backend extraction) ───────────────
  const handlePDF = async (e) => {
    ...
    setPdfName(`📄 Extracting text from ${file.name}...`);
    setError('');
    setText('');
    ...
    try {
      ...
      setPdfName(
        `✅ ${file.name} — ${res.data.characters} characters extracted`
      );
      ...
      setError(
        ...
        'PDF extraction failed. Please paste text manually.'
      );
    }
  };
  ...
  const bandStyle = (urgency) => ({
    critical : { bg: '#3b0000', border: '#f87171', color: '#f87171' },
    warning  : { bg: '#3b1a00', border: '#fb923c', color: '#fb923c' },
    caution  : { bg: '#2d2600', border: '#fbbf24', color: '#fbbf24' },
    good     : { bg: '#003b1a', border: '#34d399', color: '#34d399' },
      ...
      <div style={{ maxWidth: '860px', margin: '32px auto', padding: '0 20px' }}>
        ...
        <div className="card" style={{ marginBottom: '20px' }}>
          ...
          <textarea
            ...
            placeholder={
              "Paste your legal petition text here...\n\n" +
              "Example: The petitioner files this writ petition " +
              "under Article 32 challenging..."
            }
            style={{
        ...
        {loading && (
          <div className="card" style={{ padding: '40px 32px' }}>
            <h3 style={{
              ...
              ⚙️ Analyzing Your Petition...
            </h3>
            {[
              { icon: '📄', label: 'Reading petition text',
                sub: 'Cleaning and preprocessing...' },
              { icon: '🤖', label: 'InLegalBERT predicting',
                sub: 'Running classification model...' },
              { icon: '🧠', label: 'Qwen AI generating explanation',
                sub: 'Writing legal reasoning...' },
              { icon: '📚', label: 'FAISS searching similar cases',
                sub: 'Searching 5,000 indexed cases...' },
              { icon: '✅', label: 'Preparing results',
                sub: 'Almost done...' },
            ].map((step, i) => (
            ...
            <p style={{
              ...
              First analysis takes 2-4 minutes — subsequent ones are faster
            </p>
          </div>
        )}
        ...
        {result && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div className="card">
              ...
              {result.band && (() => {
                ...
                return (
                  <div style={{
                    ...
                    <div style={{
                      marginTop: '10px', fontSize: '13px', color: '#9ca3af'
                    }}>
                      Overall Confidence:
              ...
              <div style={{ marginBottom: '12px' }}>
                <div style={{
                  ...
                  <span style={{ color: '#34d399' }}>{result.admit_prob}%</span>
                </div>
              ...
              <div>
                <div style={{
                  ...
                  <span style={{ color: '#f87171' }}>{result.reject_prob}%</span>
                </div>
                <div className="progress-bar">
            ...
            {result.explanation && (
              <div className="card">
                ...
                <div style={{
                  ...
                  color: '#d1d5db', fontSize: '14px', whiteSpace: 'pre-wrap'
                }}>
                  {result.explanation}
                </div>
              </div>
                ...
                <div style={{
                  ...
                  {result.similar_cases.map((c, i) => (
                    <div key={i} style={{
                      background: '#0f1117',
                      border: `1px solid ${
                        c.outcome === 'ADMITTED' ? '#064e3b' : '#7f1d1d'
                      }`,
                      borderRadius: '8px', padding: '14px'
                    }}>
                      <div style={{
                        ...
                        <span style={{
                          fontWeight: '700', fontSize: '14px', color: '#667eea'
                        }}>
                          Case #{c.rank}
                        </span>
                        <div style={{ display: 'flex', gap: '8px' }}>
                          <span style={{
                            ...
                            background: '#1a1d2e', padding: '2px 10px',
                            borderRadius: '999px'
                          }}>
                            {c.similarity}% match
                          </span>
            ...
            <div style={{
              ...
              color: '#9ca3af', fontSize: '12px', textAlign: 'center'
            }}>
              ⚠️ This is an AI advisory tool only. Results do not constitute
              legal advice. Always consult a qualified legal professional before filing.
            </div>
